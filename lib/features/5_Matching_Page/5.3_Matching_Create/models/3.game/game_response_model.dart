...
class GameModelResponse extends BaseResponse {
  List<GameModel>? data;
  MetaModel? meta;
  ...
  factory GameModelResponse.fromMap(Map<String, dynamic> map) {
  ...
  factory GameModelResponse.fromJson(Map<String, dynamic> source) =>
      GameModelResponse.fromMap(source);
}
