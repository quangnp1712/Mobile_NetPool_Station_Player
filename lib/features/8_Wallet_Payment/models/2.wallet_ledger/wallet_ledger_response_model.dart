...
class WalletLedgerModelResponse extends BaseResponse {
  List<WalletLedgerModel>? data;
  MetaModel? meta;

  WalletLedgerModelResponse({
    this.data,
    this.meta,
    status,
    success,
  ...
  factory WalletLedgerModelResponse.fromMap(Map<String, dynamic> map) {
    return WalletLedgerModelResponse(
      data: map['data'] != null
          ? List<WalletLedgerModel>.from(
              (map['data'] as List).map(
                (x) => WalletLedgerModel.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
      meta: map['meta'] != null
  ...
  factory WalletLedgerModelResponse.fromJson(Map<String, dynamic> source) =>
      WalletLedgerModelResponse.fromMap(source);
}
